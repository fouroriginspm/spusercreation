		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "User Creation",
									"targetURL": "#usermanagementusercreation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"usermanagementusercreation-display": {
								"semanticObject": "usermanagementusercreation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=usermanagement.usercreation",
									"url": sap.ui.require.toUrl("usermanagement/usercreation")
								}
							}
						}
					}
